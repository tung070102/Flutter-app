...
class APIRepository {
  ...
  Future<String> forgetPass(ForgetPassM forgetPassM) async {
    try {
      final body = FormData.fromMap({
        "accountID": forgetPassM.accountID,
        "numberID": forgetPassM.numberID,
        "newPass": forgetPassM.newPass
      });
  ...
  Future<String> changePass(String token, ChangePassM changePassM) async {
    print('change pass token:$token');
    try {
      final body = FormData.fromMap({
        "OldPassword": changePassM.oldPass,
        "NewPassword": changePassM.newPass
      });
